...
public class Validation {
  //------------------常量定义  
     ...
     */
    public static final String PHONE = "(^(\\d{2,4}[-_－—])?\\d{7,8}$)|(^0?1[358]\\d{9}$)" ;  
    /** 
     * 手机号码正则表达式=^(13[0-9]|15[0-9]|18[0-9])\d{8}$
     */
    public static final String MOBILE ="^[1][358][0-9]{9}$";  
     ...
     * 不包含特殊字符/^([\u4E00-\u9FA5]\w)*$/
     */
   public static final String Special_Char="^([\u4E00-\u9FA5]||\\w)*$";
   public static final String City="^([\u4E00-\u9FA5]||\\w||\\s)*$";
...
////------------------验证方法       
    ...
    /**
     * 匹配是否包含特殊字符，没有特殊字符返回true
     * @ return boolean
     * @ param
     */
    public static boolean isSpecialChar(String str){
 	   return Regular(str,Special_Char);
    }
